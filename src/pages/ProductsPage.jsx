...
import { IoCheckmarkOutline } from "react-icons/io5"; // Updated to formal checkmark
...
const ProductsPage = () => {
  ...
  // Debug render count
  useEffect(() => {
    console.log("ProductsPage rendered", { categoryData, selectedCategory, categoriesLength: categories.length });
  });
  ...
  // Select best products (e.g., top 4 by rating or discount, with images and no video)
