...
const Faq = () => {
  ...
  return (
    ...
    >
      ...
      <p style={{ color: "#d3d3d3", marginBottom: 40, fontSize: 17, maxWidth: "40rem" }}>
      ...
      >
        ...
        <div 
          style={{ 
            flex: 1, 
            marginLeft: window.innerWidth > 768 ? 5 : 0
          }} 
          className="faq-list"
        >
          {faqData.map((item, idx) => (
            <div key={idx} style={{ marginBottom: 18 }} className="faq-item">
              <button
                ...
                style={{
                  ...
                  width: "100%",
                  textAlign: "left",
                  color: activeIndex === idx ? "#FFE180" : "#fff",
                  fontWeight: activeIndex === idx ? 700 : 200,
                  fontSize: 15,
                  cursor: "pointer",
                  padding: "8px 0",
                  borderBottom: activeIndex === idx ? "none" : "1px solid #fff2",
                  fontFamily: "'Avenir LT Std', Arial, sans-serif",
        ...
        {/* Right Side: Loader and Answer Card */}
        <div 
          style={{ 
            minWidth: 320, 
        ...
        >
          ...
          {/* Answer Card with Outer Border */}
          {!loading && activeIndex !== null && (
            <div
              className="faq-answer-card"
              style={{
                border: "1px solid #FFE180", // Moved the border here to be the only outer border
                borderRadius: 14,
                // Ensures the outer div wraps the inner card tightly
                marginRight: "-7rem",
                marginTop: 60,
            ...
            >
              <div
                ...
                style={{
                  ...
                  padding: "24px 24px 24px 32px", // Padding inside the box
                  color: "#1C3B3E",
                  fontSize: 15,
                  fontFamily: "'Avenir LT Std', Arial, sans-serif",
                  display: "flex",
              ...
              >
                ...
                <div
                  style={{
                    border: "none", // Removed inner rectangle
                    borderRadius: 8,
                    padding: "12px 15px",
                    textAlign: "center",
                    fontFamily: "'Avenir LT Std', Arial, sans-serif",
