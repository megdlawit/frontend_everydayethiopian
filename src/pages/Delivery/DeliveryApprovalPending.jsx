    ...
    <div className="flex flex-col justify-center items-center min-h-screen bg-gray-100 p-6">
      ...
      <div className="bg-white shadow-lg rounded-2xl p-10 w-full max-w-md text-center">
        ...
        <p className="text-gray-600 mt-2">
          Your delivery account is under review. We will notify you once the approval process is complete.
        </p>
...
export default DeliveryApprovalPending;