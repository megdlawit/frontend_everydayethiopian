...
const GrowthPlanAllProducts = () => {
  ...
  const handleHeroHeaderNav = (section) => {
    ...
    if (section === "shop") {
      ...
      if (el) {
        console.log('Scrolling to products-grid-section');
      ...
      const hash = sectionHashMap[section] || '';
      console.log(`Redirecting to /shop/${shop._id}${hash}`);
      navigate(`/shop/premiumpreview/${shop._id}${hash}`);
    }
  };

  const handleLogoChange = (e) => {
    console.log('Logo change is not supported in GrowthPlanAllProducts');
  };
        ...
        <div style={{ fontFamily: "Avenir LT Std" }}>
          ...
          <div className="w-full bg-white py-6 md:py-10 px-4 md:px-6 lg:px-20">
            ...
            <div className="lg:hidden flex justify-between items-center mb-6">
              <h1 className="text-3xl md:text-4xl font-quesha mb-6 text-[#1c3b3c]">
                Products
              </h1>
            ...
            <h1 className="hidden lg:block text-center text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-quesha mb-6 md:mb-10 text-[#1c3b3c]">
              Products
            </h1>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                    {currentProducts &&
                      currentProducts.map((product, index) => (
                        ...
                        >
                          <ProductCard data={{ ...product, video: undefined }} />
                        </div>
                      ))}
                  </div>
...
export default GrowthPlanAllProducts;